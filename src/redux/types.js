...
export const AUTH_PARAMS = `?consumer_key=${
  config.WC_CONSUMER_KEY
}&consumer_secret=${config.WC_CONSUMER_SECRET}&`;

export function getProductsURL(action, per_page) {
  return (
    `${BASE_URL}products${action !== undefined ? `/${action}` : ''}` +
    `${AUTH_PARAMS}per_page=${
      per_page !== undefined ? per_page : config.PRODUCTS_PER_PAGE || 10
    }` +
    `&status=publish`
  );
}
...
export function getUserValidateURL(cookie) {
  return `${API_URL}user/validate_auth_cookie/?cookie=${cookie}`;
}

export function getUserMetaURL(cookie) {
  return `${API_URL}user/get_user_meta/?cookie=${cookie}`;
}

export function getUserUpdateURL(cookie) {
  return `${API_URL}user/update_user_meta/?cookie=${cookie}`;
}
...
export const FETCH_PRODUCTS_FEATURED_SUCCESS =
...
export const FETCH_PRODUCTS_ORDER_BY_POPULARITY =
  'FETCH_PRODUCTS_ORDER_BY_POPULARITY';
export const FETCH_PRODUCTS_ORDER_BY_POPULARITY_SUCCESS =
  'FETCH_PRODUCTS_ORDER_BY_POPULARITY_SUCCESS';
export const FETCH_PRODUCTS_ORDER_BY_POPULARITY_FAILED =
  'FETCH_PRODUCTS_ORDER_BY_POPULARITY_FAILED';

export const FETCH_PRODUCTS_ORDER_BY_RATING = 'FETCH_PRODUCTS_ORDER_BY_RATING';
export const FETCH_PRODUCTS_ORDER_BY_RATING_SUCCESS =
  'FETCH_PRODUCTS_ORDER_BY_RATING_SUCCESS';
export const FETCH_PRODUCTS_ORDER_BY_RATING_FAILED =
  'FETCH_PRODUCTS_ORDER_BY_RATING_FAILED';
